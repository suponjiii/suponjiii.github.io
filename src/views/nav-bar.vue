<template>
  <nav class="navbar" role="navigation" aria-label="main navigation">
    ...
    <div class="navbar-end is-hidden-mobile">
      ...
      <a class="navbar-item" href="https://twitter.com/SUPONJI123" target="_blank">
        <span class="icon" style="color: #55acee">
          <svg class="svg-inline--fa fa-twitter fa-w-16 fa-lg" aria-hidden="true" data-prefix="fab" data-icon="twitter"
      ...
      <a class="navbar-item is-hidden-desktop-only" href="https://github.com/stefanleminh" target="_blank">
        <span class="icon" style="color: #333">
          <svg class="svg-inline--fa fa-github fa-w-16 fa-lg" aria-hidden="true" data-prefix="fab" data-icon="github"
